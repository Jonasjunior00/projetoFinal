                    ...
                    <div class="col-10">
                        <form action="?pg=usuarios-novo" method="POST">
                            <div class="form-group">
                                ...
                                <input type="text" name="nome" class="form-control" id="usuario" placeholder="Digite seu nome de usuário">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <a href="?pg=usuarios-listar" type="submit" class="btn btn-primary btn-lg" value="Inserir"> Enviar</a>
